...
import sys
print('Input TFRecord file:',str(sys.argv[1]))
infile=str(sys.argv[1])
outfile='aug_'+infile

test_data_root = os.environ['DALI_EXTRA_PATH']
#test_data_root = '/'
#tfrecord = os.path.join(test_data_root, 'data', 'kartik','aug-tfrecord-00001-of-01024')
...
#-------------------- NVIDIA DALI Pipeline Class definition---------------------------------------
#-------------------- Code from Nvidia and some class methods from James Dellinger ---------------
...
#----------------------- From Google: _convert_to_example takes inputs and builds a TFRecord -------
...
tfrecoutfile='/opt/robtest/db/tfrecord/aug/'+outfile
...
while True:
    ...
    for img_index in range(batch_size):
        ...
        fname='/opt/robtest/db/tfrecord/train/images-create/'+fname
